 ...
 * @author stephhoang
 */
public class Circle3Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Circle3Servlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        request.getRequestDispatcher("circle2.jsp").forward(request, response);
    }
            ...
            if (radiusStr == null || radiusStr.trim().isEmpty()) {
                ...
                try {
                    ...
                    if (radius < 0) {
                        ...
                        msg = "<p> Area of the circle with radius " + radius + " is: " + formattedArea + "</p>";
                    }
